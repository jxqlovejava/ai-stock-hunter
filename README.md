...
49,000+ 行 Python · 654 个测试用例 · 26 个模块 · 6 层路由管道 · 41 个量化因子 · 31 条军规 · 分钟级数据管道 · T+0 日内时机 · 宏观事件因果链
...
| 模块 | 路径 | 核心能力 |
|------|------|---------|
| 🛤️ 路由 | `src/routing/` | 6 层管道编排 + Agent-Worker 模式 + 护栏执行器 + T+0 时机 + 宏观事件 + 四视角辩论 + Munger 思维模型 |
...
| ⚡ 量化因子 | `src/factors/` + `src/alphas/` | 41 个因子：35 个 factor zoo（价值/质量/动量/波动/反转/盈利/增长/技术）+ 6 个 alpha 策略（RSI/MACD/EMA/动量） |
