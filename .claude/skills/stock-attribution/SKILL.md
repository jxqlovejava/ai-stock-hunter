...
| 🆕 市场风格/资金主线 | `python -m src market` 板块热力图 + 涨停池 + 连板高度 + 主力资金行业流向 | 当前市场主线在什么板块？本标的所在板块是被输血还是被抽血？板块资金净流入 Top 3 / 净流出 Top 3 是什么？是否存在"买预期卖事实"的利好兑现？ | `style_assessment` |
...
- [ ] Phase 2: 8 个维度 (宏观/板块/情绪/主题/政策/资金+技术/市场风格/业务结构) 全部覆盖？
  - [ ] 缺失维度已标记 `[DATA_GAP]`？
  - [ ] 🆕 市场风格/资金主线已分析？（本板块是输血还是抽血？板块资金净流入 Top 3 / 净流出 Top 3 是否列出？是否存在"买预期卖事实"？）
