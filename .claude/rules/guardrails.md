...
7. **L2 法官裁决** — 加权评分 + 置信度 + 可证伪条件
8. **L3 交易员** — 信号→仓位映射
9. **L4 风控官** — 硬约束裁剪
10. **质量审查** — 新鲜度/一致性/泄露/可解释性/安全/溯源
11. **投资者偏好 / 能力圈校验** — 仓位约束与能力圈匹配
...
| 级别 | 定义 | 示例 | 基准置信度调整 |
|------|------|------|----------------|
| `primary` | 一手来源：交易所、公司公告、央行/统计局官方 | 巨潮公告、交易所行情 | +0.10 |
| `secondary` | 二手来源：券商、财经数据商直接整理 | mootdx、tonghuashun、guosen | 0.00 |
| `tertiary` | 三手来源：聚合、爬虫、模型推断、媒体报道 | akshare 聚合、LLM 推导、资讯 NLP | -0.10 |
