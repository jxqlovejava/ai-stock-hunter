...
class ManipulationSizingEngine:
    ...
    STOP_STRATEGIES: dict[str, ManipulationStopStrategy] = {
        ...
        # ── 洗盘阶段策略（宽止损，避免被洗出）──
        "washout_sharp_drop": ManipulationStopStrategy(
            pattern_type="washout_sharp_drop",
            stop_type="wide",
            stop_loss_pct=-0.05,
            time_stop_days=3,
            urgency="low",
            description="洗盘急跌宽止损，突然打压是恐吓",
        ),
        "washout_high_open_low": ManipulationStopStrategy(
            pattern_type="washout_high_open_low",
            stop_type="wide",
            stop_loss_pct=-0.04,
            time_stop_days=3,
            urgency="low",
            description="洗盘高开低走宽止损，别被开盘吓出",
        ),
        "washout_low_open_high": ManipulationStopStrategy(
            pattern_type="washout_low_open_high",
            stop_type="wide",
            stop_loss_pct=-0.04,
            time_stop_days=2,
            urgency="low",
            description="洗盘低开高走宽止损，开盘恐慌是陷阱",
        ),
        "washout_one_sided_decline": ManipulationStopStrategy(
            pattern_type="washout_one_sided_decline",
            stop_type="wide",
            stop_loss_pct=-0.05,
            time_stop_days=3,
            urgency="low",
            description="洗盘单边下跌放宽止损，逐波下跌是恐吓",
        ),
        "washout_continuous_suppression": ManipulationStopStrategy(
            pattern_type="washout_continuous_suppression",
            stop_type="wide",
            stop_loss_pct=-0.05,
            time_stop_days=3,
            urgency="low",
            description="洗盘持续压低宽止损，沉重卖盘是假象",
        ),
        "washout_consecutive_yin": ManipulationStopStrategy(
            pattern_type="washout_consecutive_yin",
            stop_type="wide",
            stop_loss_pct=-0.05,
            time_stop_days=5,
            urgency="low",
            description="洗盘连阴宽止损，量能递减=卖压衰竭",
        ),
        "washout_support_breakdown": ManipulationStopStrategy(
            pattern_type="washout_support_breakdown",
            stop_type="wide",
            stop_loss_pct=-0.04,
            time_stop_days=3,
            urgency="low",
            description="洗盘破位宽止损，技术破位是陷阱",
        ),
        "washout_small_rise_big_drop": ManipulationStopStrategy(
            pattern_type="washout_small_rise_big_drop",
            stop_type="normal",
            stop_loss_pct=-0.03,
            time_stop_days=2,
            urgency="normal",
        ...
        "washout_long_lower_shadow": ManipulationStopStrategy(
            pattern_type="washout_long_lower_shadow",
            stop_type="wide",
            stop_loss_pct=-0.04,
            time_stop_days=3,
            urgency="normal",
            description="长下影收针：避免在影线低点割；破前低再收紧",
        ),
